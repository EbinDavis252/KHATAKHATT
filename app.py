...
if not st.session_state.logged_in:
    ...
    with nav_col1:
        st.markdown(f"<h2>💸 KhataKhat <span style='color: #64748b; font-size: 20px; font-weight: 400;'>| {t('Enterprise Receivables', 'स्मार्ट व्यापार वसूली')}</span></h2>", unsafe_allow_html=True)
    with nav_col2:
